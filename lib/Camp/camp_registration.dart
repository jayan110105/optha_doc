  ...
  void scanAadhar() {
    ...
    Future.delayed(Duration(seconds: 2), () {
      setState(() {
        ...
        step = 2; // Move to the gender step
      });
    });
  }
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    offset: const Offset(0, 4), // Shadow position (horizontal, vertical)
                  ),
                ],
              ),
              child: IndexedStack(
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: formData["photo"] == null
                              ? Icon(Icons.camera_alt, color: Color(0xFF163351).withValues(alpha: 0.4), size: 50)
                              : null,
                        ),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                gender,
                                style: TextStyle(color: formData["gender"] == gender ?
                                                        Colors.grey[200] :
                                                        Color(0xFF163351),
                                ),
                              ),
